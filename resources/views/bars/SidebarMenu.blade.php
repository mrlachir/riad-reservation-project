    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li><a href="{{ route('manage.reviews') }}" class="sidebar-link"><i class="fas fa-star"></i> Reviews</a></li>
                ...
                <li><a href="{{ route('home.page') }}" class="sidebar-link"><i class="fas fa-home"></i> Home</a></li>
            </ul>
        </nav>
    </div>
